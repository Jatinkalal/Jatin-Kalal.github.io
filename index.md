...
<body>
...
</html>" alt="Item Range Search System Image">
    ...
    <div class="references">
        <h2>References</h2>
        <p>GeeksforGeeks (GFG) 'System Architecture for E-commerce'.</p>
        <p>Medium 'Building scalable E-commerce empire'.</p>
